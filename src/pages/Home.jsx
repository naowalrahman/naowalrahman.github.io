    ...
    return (
        <div className="home">
            ...
            >
                ...
                >
                    <p>
                        Hi! I'm a freshman at Columbia University studying computer science and applied physics. Broadly, 
                        I'm also interested in mathematics, theoretical physics, robotics, engineering, and Linux. More 
                        specifically, that involves machine learning, computer vision, computational complexity theory and 
                        its applications to robotics, and system level programming. I love working across the tech stack, 
                            ...
                            {activeTab === 'cp' && (
                                <div className="card">
                                    <div className="card-body">
                                        ...
                                        <div className={`list-item ${fade ? 'fade' : ''}`}>
                                            <FaCode className="list-item-icon" />
                                            <span>PyTorch, Flask, NumPy, Pandas, MERN Stack, Bootstrap, Neovim, JuMP (and many more!)</span>
                                        </div>
                                        <div className={`list-item ${fade ? 'fade' : ''}`}>
                                            <FaCode className="list-item-icon" />
                            ...
                            {activeTab === 'reading' && (
                                <div className="card">
                                    <div className="card-body">
                                        ...
                                        <div className={`list-item ${fade ? 'fade' : ''}`}>
                                            <FaBook className="list-item-icon" />
                                            <span>How Not to Be Wrong: The Power of Mathematical Thinking, Jordan Ellenberg</span>
                                        </div>
                                        <div className={`list-item ${fade ? 'fade' : ''}`}>
                                            <FaBook className="list-item-icon" />
                    ...
                    <div className="links-section">
                        <p>
                            ...
                            <a href="https://github.com/naowalrahman" className="text-link" target="_blank" rel="noreferrer">
                                GitHub
                            </a>!
                        </p>
                    </div>
