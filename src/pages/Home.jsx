                    ...
                    <div className="tabs-container">
                        ...
                        <div className="tab-content">
                            {activeTab === "experience" && (
                                <div className="card-body">
                                    <p>
                                        ...
                                        . My primary research concerns developing both specialized and foundation models
                                        for various biological modalities, most recently the brain and the heart.
                                    </p>
                                    <p>
                                        ...
                                        simulatable and generalizable algorithm for finding the path of least time in a
                                        randomized track. We're a small but enthusiastic team of roboticists developing
                                        completely from scratch, so please reach out to me if interested!
                                    </p>
                                    <p>
                            ...
                            {activeTab === "fun" && (
                                <div className="card-body">
                                    <p>
                                        I like customizing Neovim a lot, and have been experimenting with and trying to
                                        improve AI-powered coding workflows in Neovim. Lately, I've found{" "}
                                        <a
                                    ...
                                    <div className="book-cards">
                                        <div className="book-card">
                                            ...
                                            <div className="book-desc">
                                                ...
                                                saying "when you multiply some physical quantities together, it happens
                                                to be the same as multiplying some other physical quantities together."
                                                The universe is incredibly elegant and needs no frameworks - we only
                                                invent frameworks to understand it for ourselves.
                                            </div>
                                        </div>
                                        <div className="book-card">
                                            <div className="book-title">How Not to Be Wrong, Jordan Ellenberg</div>
                                            <div className="book-desc">
                                                There is a chapter on how a group of MIT students legally exploited a
                                                loophole in the Massachusetts Cash WinFall lottery, using expected value
                                                to guarantee profits with high volumes of tickets. While events like
                                                this are rare, I think it shows that there's merit in developing
                                                mathematical maturity and trying to apply it everywhere.
                                            </div>
                                        </div>
                                        <div className="book-card">
                                            <div className="book-title">Something Deeply Hidden, Sean Carroll</div>
                                            <div className="book-desc">
                                                The theory of multiverses honestly just captivated my imagination, and I
                                                appreciate that Sean Carroll simplified a concept very bogged-down in
                                                quantum mechanics for people who aren't theoretical physicists.
                                            </div>
                                        </div>
                                        <div className="book-card">
                                            ...
                                            <div className="book-desc">
                                                ...
                                                social commentary. I remember constantly trying to imagine what it would
                                                be like to live in Camazotz under the rule of IT. I couldn't quite
                                                render the image of the bouncing balls scene in my head.
                                            </div>
                                        </div>
                                    </div>
                                </div>
