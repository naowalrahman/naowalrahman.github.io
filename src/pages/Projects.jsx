...
const sideHobbiesData = [
    {
        ...
        description: 'A repository of algorithm, data structure, and problem implementations from various programming contests and websites I participate in.',
        link: 'https://github.com/naowalrahman/competitive-programming'
    },
    {
        languages: 'Lua',
        title: 'Naowal.nvim',
        description: 'A custom Neovim configuration built on LazyVim that I continuosly update and maintain in my free time. Features a custom file runner, dashboard, and supertab implementation.',
        link: 'https://github.com/naowalrahman/naowal.nvim'
    },
    {
        languages: 'Bash, Python, JSON, YAML',
        title: 'Dotfiles',
        description: 'My custom Arch Linux configuration running Hyprland. Using the foot terminal, zsh with zinit and tmux, the pure prompt, themed Firefox, waybar, tofi, btop, and dunst.',
        link: 'https://github.com/naowalrahman/dotfiles'
    },
    {
        languages: 'Processing, Java',
        title: 'Gravity Guy',
        description: 'A fun, objected-oriented recreation of Gravity Guy. There is level selection, collision detection, touchable and untouchable objects, and restarting capability.',
    ...
    },
    {
        ...
        title: 'RISer',
        description: 'A reverse image search browser extension for chromium-based browsers. Uses the Google Images API.',
            ...
            >
                {sideHobbiesData.map((hobby, idx) => (
                    <div
                        key={idx}
                        className="project-card"
                        onClick={() => window.open(hobby.link, '_blank')}
                    >
